...
class PostmetaSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $postmetas = array(
      ...
      array('id' => '54', 'post_id' => '21', 'key' => 'excerpt', 'value' => 'WA Bulk messaging is the dissemination of large numbers of messages for delivery to URSender software. It is used by media companies, banks and other enterprises and consumer brands for a variety of purposes including entertainment, enterprise and mobile marketing.'),
      ...
      array('id' => '62', 'post_id' => '23', 'key' => 'excerpt', 'value' => 'URSender is the best quaint james bond victoria sponge happy days cras.'),
      array('id' => '63', 'post_id' => '24', 'key' => 'excerpt', 'value' => 'No you can simply register with your email'),
      array('id' => '64', 'post_id' => '25', 'key' => 'excerpt', 'value' => 'URSender has supported free 10 days trial. You don\'t need to add credit card information.'),
